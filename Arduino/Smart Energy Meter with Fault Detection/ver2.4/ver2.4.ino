...
//    float diff_current = fabs(amps_2 - amps);
//    Serial.println(diff_current,4);
    if (fabs(amps_2 - amps) > 0.007)  // 0.007 and 0.006 both are working in most cases 
    {
    ...
    if (fabs(current_thresh - amps) < 0.01)
    {
      lcd.clear();
      lcd.setCursor(4,0);
      lcd.print("Load Exceed");
      delay(50);
      lcd.setCursor(0,2);
      lcd.print("Meter in Cutoff mode");
      delay(50);
